...
/**
 * Use {@link java.util.Arrays#sort(int[])} instead.
 *
 * @author henengqiang
 * @date 2019/06/11
 */
public class SortUtils {
    ...
    /**
     * 对Map按key进行排序
     * 推荐使用 {@link SortUtils#sortMapByKey(java.util.Map, boolean)}
     * @param map   等待排序的map
     * @param isAsc true: 升序，false: 降序
     * @return      排序后的map
     */
    ...
    /**
     * 使Map按value排序（升序）
     * 推荐使用 {@link SortUtils#sortMapByValue(java.util.Map, boolean)}
     */
