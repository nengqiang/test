...
$ = window.$ || {},
    ...
    $.RSA = $pt.RSA = function () {
            ...
            if (!(o.t <= 0)) {
                ...
                if (0 != d) {
                    ...
                    for (r.dlShiftTo(_, v),
                        ...
                        r[r.t++] = 0;
                    for (; --_ >= 0;) {
                        var b = n[--m] == d ? this.DM : Math.floor(n[m] * h + (n[m - 1] + w) * g);
                        if ((n[m] += r.am(0, b, n, _, 0, l)) < b)
                            for (r.dlShiftTo(_, v),
                                     n.subTo(v, n); n[m] < --b;)
                                n.subTo(v, n)
                    }
        ...
        function G(t, e) {
            var n;
            return n = t < 256 || e.isEven() ? new x(e) : new U(e),
                this.exp(t, n)
        }
        ...
        for (at = "A".charCodeAt(0),
                 pt = 10; pt < 36; ++pt)
            ct[at++] = pt;
        x.prototype.convert = M,
            x.prototype.revert = O,
            x.prototype.reduce = B,
            x.prototype.mulTo = R,
            x.prototype.sqrTo = H,
    ...
    function (t) {
        ...
        t.TEA = {
            ...
            enAsBase64: function (t, e) {
                for (var n = h(t, e), o = s(n), i = "", r = 0; r < o.length; r++)
    ...
    $.Encryption = $pt.Encryption = function () {
        ...
        function h(e, n, o, i) {
            ...
            return function () {
                ...
                window.btoa(d(h)).replace(/[\/\+=]/g, function (t) {
                    return {
                        "/": "-",
                        "+": "*",
                        "=": "_"
