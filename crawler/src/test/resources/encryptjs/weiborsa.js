...
function encrypt(servertime, nonce, password, rsaPubkey) {
    var RSAKey = new sinaSSOEncoder.RSAKey();
    RSAKey.setPublic(rsaPubkey, "10001");
    var pwd = RSAKey.encrypt([servertime, nonce].join("\t") + "\n" + password)
    return pwd;
}